...
const PAGE_CONFIG: Record<ManagedPageKey, PageConfig> = {
  home: {
    ...
    icon: Home,
    route: '/',
    defaultTitleAr: 'CIAR RE',
    defaultTitleEn: 'CIAR RE',
    defaultSubtitleAr: 'سجّل، أضف عقارك، وابدأ خلال دقائق — كل شيء بسيط وواضح',
    defaultSubtitleEn: 'Sign up, add your property, go live in minutes — simple from start to finish',
